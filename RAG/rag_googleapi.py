...
class RAG:
    ...
    def ask(self, question):
        ...
        decompose_template = """Please decompose "{question}" into 3 sub-questions in order, each question on a separate line:"""
        try:
        ...
        prompt_template = (
            "Answer the question based on the context below. If there is insufficient information, only respond 'No relevant information available'.\n"
            "Context:\n{context}\n\n"
            "{question}\n"
            "Answer in detail, list each issue if any:"
        )
